...
Definition _is_equal : ident := $"is_equal".
...
Definition f_is_equal := {|
  fn_return := tint;
  fn_callconv := cc_default;
  fn_params := ((_s, (tptr tuchar)) :: (_t, (tptr tuchar)) ::
                (_len, tulong) :: nil);
  fn_vars := nil;
...
(Ssequence
  ...
  (Ssequence
    ...
    (Ssequence
      (Scall (Some _t'1)
        (Evar _is_equal (Tfunction
                          ((tptr tuchar) :: (tptr tuchar) :: tulong :: nil)
                          tint cc_default))
        ((Ebinop Oadd (Etempvar _s (tptr tuchar))
           (Econst_int (Int.repr 1) tint) (tptr tuchar)) ::
         (Ebinop Oadd (Etempvar _t (tptr tuchar))
           (Econst_int (Int.repr 1) tint) (tptr tuchar)) ::
         (Ebinop Osub (Etempvar _len tulong) (Econst_int (Int.repr 1) tint)
           tulong) :: nil))
...
Definition f_compress := {|
  ...
  fn_temps := ((_out_len, tulong) :: (_out, (tptr tuchar)) ::
               ...
               (_len_opt, tulong) :: (_off_opt, tulong) :: (_t'6, tulong) ::
               (_t'5, tulong) :: (_t'4, tulong) :: (_t'3, tulong) ::
               (_t'2, tulong) :: (_t'1, (tptr tvoid)) :: (_t'11, tulong) ::
               (_t'10, tulong) :: (_t'9, tulong) :: (_t'8, tuchar) ::
               (_t'7, tulong) :: nil);
  fn_body :=
(Ssequence
  (Sset _out_len
  ...
  (Ssequence
    ...
    (Ssequence
      ...
      (Ssequence
        (Sset _out_i (Ecast (Econst_int (Int.repr 20) tint) tulong))
        (Ssequence
                                          ...
                                          (Ssequence
                                            ...
                                            (Sset _out_i
                                              (Ebinop Oadd
                                                ...
                                                (Econst_int (Int.repr 1) tint)
                                                tulong)))
                                          (Sset _t'5 (Etempvar _in_i tulong)))
                                        (Sset _in_i
...
((___compcert_va_int32,
 ...
 (_is_equal, Gfun(Internal f_is_equal)) ::
...
(_main :: _decompress :: _compress :: _find_largest_match :: _is_equal ::
